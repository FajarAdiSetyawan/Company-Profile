                    ...
                    foreach ($kategori as $key => $value) : ?>
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <!-- <a href="<?= base_url('user/hapus/' . $value->id_kategori); ?>" class="btn btn-danger" data-confirm="Hapus Data?|Apakah Mau Lanjut?" data-confirm-yes="<?= base_url('user/hapus/' . $value->id_kategori); ?>"> <i class="fas fa-trash"></i> Hapus</a> -->
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="<?= base_url('kategori/editkategoriberita/' . $value->id_kategori); ?>" class="needs-validation" novalidate>
  ...
  <div class="modal fade" id="hapus<?= $value->id_kategori; ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form method="POST" action="<?= base_url('kategori/hapuskategoriberita/' . $value->id_kategori); ?>">

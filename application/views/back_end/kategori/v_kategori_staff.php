    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="<?= base_url('kategori/editkategoristaff/' . $value->id_kategori); ?>" class="needs-validation" novalidate>
  ...
  <div class="modal fade" id="hapus<?= $value->id_kategori; ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form method="POST" action="<?= base_url('kategori/hapuskategoristaff/' . $value->id_kategori); ?>">
